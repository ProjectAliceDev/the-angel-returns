...
OEM Website: https://theangelreturns.aliceos.app
OEM Support Email: theangelreturns@aliceos.app
    """

    license = """\
The Angel Returns is a Doki Doki Literature Club fan mod that is not affiliated with Team Salvato or theMeatly Games Ltd. It is designed to be played only after the official game has been completed, and contains spoilers for the official game(s). Game files for Doki Doki Literature Club are required to play this mod and can be downloaded for free at: http://ddlc.moe. This game also contains highly sensitive content and is not suitable for children or those who are easily disturbed.
