                ...
                python:
                    ...
                    for obj in gc.get_objects():
                        if isinstance(obj, Applet):
                            ...
                            elif obj.author == "Project Alice" or obj.author == "Team Salvato" or obj.author == "Chrysalis Systems LLC.":
...
style applets_button is gui_button:
    activate_sound gui.activate_sound
    hover_sound gui.hover_sound

style applets_button_text is gui_text:
    size 22
    color "#fff"
    font gui.name_font
    outlines [(1, aliceos_oem_pink[500])]
